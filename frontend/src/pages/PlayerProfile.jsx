...
const PHOTOS_URL = import.meta.env.VITE_PROFILE_PHOTOS;
...
const PlayerProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append('fecha_nacimiento', editedData.FECHA_NACIMIENTO);
    if (profilePhoto) {
    ...
    try {
      ...
      if (data.player.FOTO_PERFIL) {
        setPhotoPreview(`${PHOTOS_URL}${data.player.FOTO_PERFIL}`);
      }
      ...
      <Row className="g-0">
        ...
        <Col xs={12} md={10} className="p-0">
          ...
          <div className="p-4">
            ...
            <Card>
              <Card.Body>
                {/* Renderizado condicional del loader o del formulario */}
                {loading ? (
                  ...
                  <Form onSubmit={handleSubmit}>
                    <div className="d-flex flex-column align-items-center mb-4">
                      <Image
                        src={photoPreview || (playerData.FOTO_PERFIL ? `${PHOTOS_URL}${playerData.FOTO_PERFIL}` : 'https://via.placeholder.com/150')}
                        roundedCircle
